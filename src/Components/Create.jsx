        ...
        <div>
            ...
            <div className="w-[95%] md:w-[80%] mx-auto my-5 md:mb-16 bg-[#F4F3F0] p-5 md:p-20">
                <div className="text-center md:w-[70%] mx-auto">
                        <h3 className="text-4xl rancho-regular mb-3">Add New Coffee</h3>
                ...
                <form onSubmit={handleAddCoffee} >
                    ...
                    <input className="btn text-[20px] rancho-regular bg-[#D2B48C] w-full mt-6" type="submit" value="Add Coffee" />
                </form>
            </div>
        </div>
    );
